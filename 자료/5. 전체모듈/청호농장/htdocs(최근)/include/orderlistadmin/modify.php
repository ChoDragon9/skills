...
<div class="w100 h30 fl"><?php img("/img/statechange.png","3 상태변경하기");?></div>
<form action="<?php echo PAGE."/modify_ok";?>" method="post">
<div class="content">
	<ul>
		<li class="w20 bg"><?php nb(3); ?>현제상태</li>
		<li class="w80 ft18 fw cr"><?php nb(2); echo $row['state']; $input->input("hidden","num",$row['no']);?></li>
	</ul>
	<ul>
		<li class="w20 bg"><?php nb(3); ?>변경할 상태</li>
		<li class="w80"><?php nb(3); ?>
		<select name="state" id="state">
		<?php
		$statearr = array("배송준비중","배송중","배송완료");
