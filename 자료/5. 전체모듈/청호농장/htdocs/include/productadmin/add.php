<form action="<?php echo PAGE."/add_ok";?>" method="post" enctype="multipart/form-data" onsubmit="return frmchk('product');">
<div class="content">
	<ul>
		<li class="w20 bg"><?php nb(3); label("상품명","name");?></li>
		<li class="w30"><?php nb(3); $input->input("text","name","","20"); $input->input("hidden","state","insert");?></li>
	...
	<ul class="bt">
		<li><?php $input->input("submit","등록하기"); nb(); $input->input("button","뒤로가기","move('".PAGE."');");?></li>
	</ul>
</div>
</form>